...
with open('src/components/BloodborneTrophyList.jsx', 'r', encoding='utf-8') as f:
    content = f.read()

pattern = r'const trophyGroups = \[[\s\S]*?\];\n\nexport default function'
replacement = 'const trophyGroups = ' + json.dumps(bbTrophies, ensure_ascii=False, indent=2) + ';\n\nexport default function'

new_content = re.sub(pattern, replacement, content)

with open('src/components/BloodborneTrophyList.jsx', 'w', encoding='utf-8') as f:
    f.write(new_content)

print("Replaced trophy groups successfully.")
