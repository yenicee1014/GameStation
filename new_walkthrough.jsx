...
import { Search, Heart, Share2, Bookmark, ChevronDown, ChevronRight, BookOpen, ShoppingCart, Crosshair, Swords, Shield, Coins, Move, Hand, Target, Map } from 'lucide-react';
...
export default function WalkthroughBloodborne() {
  ...
  return (
    ...
    >
      ...
      {/* Progress Bar */}
      <div className="fixed top-[60px] left-0 w-full h-1 bg-gray-800 z-50">
        <div 
          className="h-full bg-sspai-red transition-all duration-150 ease-out"
      ...
      <main className="pt-[100px] pb-20 max-w-[1400px] mx-auto px-4 md:px-6 flex gap-10 lg:gap-14">
          ...
          <article className="flex-1 min-w-0 bg-white rounded-lg shadow-sspai p-8 md:p-12 md:pb-16 transition-shadow text-black">
             ...
             <div className="flex items-center justify-between mb-10 pb-8 border-b border-gray-100">
               <div className="flex items-center gap-4">
                 <div className="w-10 h-10 rounded-full overflow-hidden border border-gray-100 shadow-sm cursor-pointer hover:ring-2 hover:ring-sspai-red/20 transition-all bg-black flex items-center justify-center">
                   <span className="text-white font-bold text-xs">FS</span>
                 </div>
                 <div className="flex flex-col justify-center">
                   <div className="flex items-center gap-2">
                     <span className="font-bold text-[15px] text-black hover:text-sspai-red cursor-pointer transition-colors">From Software</span>
                     <span className="px-1.5 py-[1px] bg-[#f0f0f0] text-gray-500 text-[10px] font-bold rounded uppercase tracking-wider">作者</span>
                   </div>
             ...
             <div className="prose prose-lg max-w-none prose-headings:font-bold prose-headings:text-black prose-headings:tracking-tight prose-p:text-black prose-p:leading-[1.8] prose-p:mb-6 prose-a:text-sspai-red prose-a:no-underline prose-a:border-b prose-a:border-sspai-red/30 hover:prose-a:border-sspai-red hover:prose-a:bg-red-50/50 prose-a:transition-all prose-img:rounded-lg prose-img:shadow-sm prose-blockquote:border-l-4 prose-blockquote:border-sspai-red prose-blockquote:bg-gray-50 prose-blockquote:py-2 prose-blockquote:px-4 prose-blockquote:rounded-r prose-blockquote:not-italic prose-blockquote:text-black prose-li:text-black prose-strong:text-black prose-strong:font-bold">
                       ...
                       <div className="flex flex-col gap-4">
                         ...
                         <div className="flex items-center justify-between">
                           <div className="flex flex-col">
                             ...
                             <span className="text-2xl font-bold text-sspai-red">HK$ 74.00</span>
                           </div>
                           <span className="px-2.5 py-1 bg-red-50 text-sspai-red text-xs font-bold rounded">-50%</span>
                         </div>
                     ...
                     <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col h-full">
                       ...
                       <div className="flex-1 grid grid-cols-1 content-center gap-1">
                         <div className="group flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors border-b border-gray-50/50 last:border-0">
                           ...
                           <span className="font-semibold text-gray-900">FromSoftware</span>
                         </div>
                         <div className="group flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors border-b border-gray-50/50 last:border-0">
                           <span className="text-gray-500 font-medium flex items-center gap-2.5 text-sm">
                         ...
                         <div className="group flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors border-b border-gray-50/50 last:border-0">
                           ...
                           <span className="font-semibold text-gray-900">2015-03-24</span>
                         </div>
                         <div className="group flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors border-b border-gray-50/50 last:border-0">
                           <span className="text-gray-500 font-medium flex items-center gap-2.5 text-sm">
                             <span className="w-5 text-center">🎯</span> 游戏类型
                           </span>
                           <span className="font-semibold text-gray-900">动作角色扮演 (ARPG)</span>
                         </div>
                         <div className="group flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors border-b border-gray-50/50 last:border-0">
                           <span className="text-gray-500 font-medium flex items-center gap-2.5 text-sm">
                             <span className="w-5 text-center">🕹️</span> 对应平台
                           </span>
                           <span className="font-semibold text-gray-900">PS4</span>
                         </div>
                         <div className="group flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors border-b border-gray-50/50 last:border-0">
                           <span className="text-gray-500 font-medium flex items-center gap-2.5 text-sm">
                             <span className="w-5 text-center">👥</span> 游玩人数
                           </span>
                           <span className="font-semibold text-gray-900">1人 (支持在线联机)</span>
                         </div>
                         <div className="group flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors border-b border-gray-50/50 last:border-0">
                           <span className="text-gray-500 font-medium flex items-center gap-2.5 text-sm">
                             <span className="w-5 text-center">💰</span> 参考价格
                           </span>
                           <span className="font-bold text-sspai-red text-base">HK$ 148.00</span>
                         </div>
                         <div className="group flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors border-b border-gray-50/50 last:border-0">
                           <span className="text-gray-500 font-medium flex items-center gap-2.5 text-sm">
                             <span className="w-5 text-center">🌐</span> 语言支持
                           </span>
                           <span className="font-semibold text-gray-900 text-right max-w-[50%] leading-tight">繁体中字 / 英文语音</span>
                         </div>
               ...
               <div className="grid md:grid-cols-3 gap-6 mb-10">
                  <div className="bg-gray-50 p-5 rounded-lg border border-gray-100">
                    <h4 className="font-bold text-lg mb-2 text-sspai-red">哥特式恐怖设定</h4>
                  ...
                  <div className="bg-gray-50 p-5 rounded-lg border border-gray-100">
                    <h4 className="font-bold text-lg mb-2 text-sspai-red">激进的战斗系统</h4>
                    <p className="text-sm text-gray-600 m-0">
                  ...
                  <div className="bg-gray-50 p-5 rounded-lg border border-gray-100">
                    <h4 className="font-bold text-lg mb-2 text-sspai-red">独特的诡兵器</h4>
                    <p className="text-sm text-gray-600 m-0">
                  ...
                  <table className="w-full text-left border-collapse bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200">
                    ...
                    <tbody className="divide-y divide-gray-100 text-[15px]">
                      <tr>
                        ...
                        <td className="px-6 py-4 text-green-600 font-bold">92/100</td>
                        <td className="px-6 py-4 text-gray-500 italic">"FromSoftware 的巅峰之作，将动作 RPG 推向了新的高度。"</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 font-medium">IGN</td>
                        <td className="px-6 py-4 text-sspai-red font-bold">9.1/10</td>
                        <td className="px-6 py-4 text-gray-500">"一场令人精疲力竭却又无比满足的受苦之旅。"</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 font-medium">GameSpot</td>
                        <td className="px-6 py-4 font-bold">9/10</td>
                        <td className="px-6 py-4 text-gray-500">"雅南的恐怖令人着迷，令人惊叹的 Boss 战和引人入胜的探索。"</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 font-medium">Famitsu (Fami通)</td>
                        <td className="px-6 py-4 font-bold">36/40</td>
                        <td className="px-6 py-4 text-gray-500">"独特的战斗节奏和极高的重玩价值。"</td>
                      </tr>
                    </tbody>
                  </table>
               </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
                 <div className="rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow group aspect-video">
                   <img src="https://image.api.playstation.com/vulcan/img/rnd/202010/2614/g3PIfqX3gT7v2q0N1b4G9A5x.jpg" alt="Screenshot 1" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500" onError={(e) => { e.target.src = bloodborneCover }} />
                 </div>
                 <div className="rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow group aspect-video">
                   <img src="https://image.api.playstation.com/vulcan/img/rnd/202010/2614/a1B2C3d4E5f6G7h8I9j0K1l2.jpg" alt="Screenshot 2" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500" onError={(e) => { e.target.src = bloodborneCover }} />
                 </div>
                 <div className="rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow group aspect-video">
                   <img src="https://image.api.playstation.com/vulcan/img/rnd/202010/2614/m3N4o5P6q7R8s9T0u1V2w3X4.jpg" alt="Screenshot 3" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500" onError={(e) => { e.target.src = bloodborneCover }} />
                 </div>
                 <div className="rounded-lg overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow group aspect-video">
                   <img src="https://image.api.playstation.com/vulcan/img/rnd/202010/2614/y5Z6a7B8c9D0e1F2g3H4i5J6.jpg" alt="Screenshot 4" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500" onError={(e) => { e.target.src = bloodborneCover }} />
                 </div>
               </div>

               {/* Gameplay */}
               <h2 id="section-gameplay" className="text-3xl mt-16 mb-8 group cursor-pointer text-black border-b pb-4 flex items-center gap-2">
                  <span className="text-sspai-red opacity-0 group-hover:opacity-100 transition-opacity -ml-6 w-6 text-center font-normal">#</span>
                  游戏玩法
               </h2>

               {/* Controls */}
               <h3 id="section-controls" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 <Crosshair className="text-sspai-red" /> 控制说明
               </h3>
               ...
               <div className="overflow-x-auto mb-10">
                 <table className="w-full text-left border-collapse min-w-[600px] bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200">
                   <thead className="bg-gray-50 text-gray-700 text-sm uppercase tracking-wider">
                     <tr>
                       <th className="px-6 py-3 border-b border-gray-200 font-bold w-1/3">控制按键</th>
                       <th className="px-6 py-3 border-b border-gray-200 font-bold">描述</th>
                     </tr>
                   </thead>
                   <tbody className="divide-y divide-gray-100 text-[15px] text-gray-700">
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-6 py-4 font-semibold flex items-center gap-2"><Move size={16}/> 左摇杆</td>
                       <td className="px-6 py-4">角色移动</td>
                     </tr>
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-6 py-4 font-semibold flex items-center gap-2"><Move size={16}/> 右摇杆</td>
                       <td className="px-6 py-4">视角移动</td>
                     </tr>
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-6 py-4 font-semibold">十字键</td>
                     ...
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-6 py-4 font-semibold flex items-center gap-2"><Hand size={16}/> X 键</td>
                       <td className="px-6 py-4">互动</td>
                     </tr>
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-6 py-4 font-semibold flex items-center gap-2"><Move size={16}/> ⭕ 键 (Circle)</td>
                       <td className="px-6 py-4">
                         <div className="space-y-1">
                           <div className="text-sm"><span className="text-sspai-red font-medium">锁定敌人时：</span>侧步或后撤步</div>
                           <div className="text-sm"><span className="text-gray-500 font-medium">附近没有敌人时：</span>翻滚或冲刺（长按）</div>
                         </div>
                       </td>
                     </tr>
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-6 py-4 font-semibold">⬜ 键 (Square)</td>
                       <td className="px-6 py-4">使用装备的消耗品</td>
                     </tr>
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-6 py-4 font-semibold text-sspai-red">🔺 键 (Triangle)</td>
                       <td className="px-6 py-4">使用采血瓶</td>
                     </tr>
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-6 py-4 font-semibold">L1</td>
                       <td className="px-6 py-4">
                         变形右手诡兵器<br/>
                     ...
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-6 py-4 font-semibold flex items-center gap-2"><Swords size={16}/> R1</td>
                       <td className="px-6 py-4">使用装备的右手武器攻击</td>
                     </tr>
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-6 py-4 font-semibold flex items-center gap-2"><Shield size={16}/> L2</td>
                       <td className="px-6 py-4">
                         使用装备的左手武器攻击<br/>
                     ...
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-6 py-4 font-semibold">R2</td>
                       <td className="px-6 py-4">
                         使用右手武器进行重攻击<br/>
                     ...
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-6 py-4 font-semibold flex items-center gap-2"><Target size={16}/> R3 (按下右摇杆)</td>
                       <td className="px-6 py-4">
                         <div className="space-y-1">
                           <div className="text-sm"><span className="text-sspai-red font-medium">附近有敌人时：</span>锁定</div>
               ...
               {/* Basics */}
               <h3 id="section-basics" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 <BookOpen className="text-sspai-red" /> 基础知识
               </h3>
               ...
               {/* Health & Death */}
               <h3 id="section-health-death" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 <Heart className="text-sspai-red" /> 生命与死亡
               </h3>
               ...
               <p className="text-gray-700 mb-4">有两种方法可以恢复生命值：<strong>采血瓶（Blood Vials）</strong>和<strong>虚血回复（Regain）</strong>。</p>
               ...
               <h3 id="section-blood-echoes" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 <Coins className="text-sspai-red" /> 血之回响与升级
               </h3>
               <p className="text-gray-700 mb-4">
               ...
               <h3 id="section-insight" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 <Search className="text-sspai-red" /> 灵视
               </h3>
               <p className="text-gray-700 mb-8">
               ...
               <h3 id="section-saving-loading" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 <Bookmark className="text-sspai-red" /> 保存与读取
               </h3>
               <p className="text-gray-700 mb-8">
               ...
               <h3 id="section-weapons-equipment" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 <Swords className="text-sspai-red" /> 武器与装备
               </h3>
               <p className="text-gray-700 mb-4">您可以给猎人装备两种类型的武器：右手武器和左手武器。</p>
               ...
               <div className="overflow-x-auto mb-6">
                 <table className="w-full text-left border-collapse min-w-[400px] bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200">
                   <thead className="bg-gray-50 text-gray-700 text-sm tracking-wider">
                     <tr>
                       <th className="px-6 py-3 border-b border-gray-200 font-bold w-24">等级</th>
                       <th className="px-6 py-3 border-b border-gray-200 font-bold">所需材料</th>
                     </tr>
                   </thead>
                   <tbody className="divide-y divide-gray-100 text-[15px] text-gray-700">
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-6 py-3 font-semibold">+1</td><td className="px-6 py-3">3个 血石碎片</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-6 py-3 font-semibold">+2</td><td className="px-6 py-3">5个 血石碎片</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-6 py-3 font-semibold">+3</td><td className="px-6 py-3">8个 血石碎片</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-6 py-3 font-semibold">+4</td><td className="px-6 py-3">3个 双子血石碎片</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-6 py-3 font-semibold">+5</td><td className="px-6 py-3">5个 双子血石碎片</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-6 py-3 font-semibold">+6</td><td className="px-6 py-3">8个 双子血石碎片</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-6 py-3 font-semibold">+7</td><td className="px-6 py-3">3个 血石块</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-6 py-3 font-semibold">+8</td><td className="px-6 py-3">5个 血石块</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-6 py-3 font-semibold">+9</td><td className="px-6 py-3">8个 血石块</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-6 py-3 font-semibold">+10</td><td className="px-6 py-3">1个 血岩</td></tr>
                   </tbody>
                 </table>
               </div>
               <p className="text-gray-700 mb-8">
               ...
               <h3 id="section-attire-sets" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 <Shield className="text-sspai-red" /> 服饰套装
               </h3>
               <p className="text-gray-700 mb-8">
               ...
               <h3 id="section-items" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 <ShoppingCart className="text-sspai-red" /> 物品
               </h3>
               ...
               <h2 id="section-character-creation" className="text-3xl mt-16 mb-8 group cursor-pointer text-black border-b pb-4 flex items-center gap-2">
                  <span className="text-sspai-red opacity-0 group-hover:opacity-100 transition-opacity -ml-6 w-6 text-center font-normal">#</span>
                  角色创建
               </h2>
               <p className="text-gray-700 mb-8">
               ...
               <h3 id="section-origin" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 <Hand className="text-sspai-red" /> 出身
               </h3>
               <p className="text-gray-700 mb-6">
               ...
               <div className="overflow-x-auto mb-10">
                 <table className="w-full text-left border-collapse min-w-[600px] bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200">
                   <thead className="bg-gray-50 text-gray-700 text-sm tracking-wider">
                     <tr>
                       <th className="px-4 py-3 border-b border-gray-200 font-bold">出身</th>
                       <th className="px-4 py-3 border-b border-gray-200 font-bold">回响</th>
                       <th className="px-4 py-3 border-b border-gray-200 font-bold">活力</th>
                       <th className="px-4 py-3 border-b border-gray-200 font-bold">持久力</th>
                       <th className="px-4 py-3 border-b border-gray-200 font-bold">力量</th>
                       <th className="px-4 py-3 border-b border-gray-200 font-bold">技巧</th>
                       <th className="px-4 py-3 border-b border-gray-200 font-bold">血质</th>
                       <th className="px-4 py-3 border-b border-gray-200 font-bold">秘法</th>
                     </tr>
                   </thead>
                   <tbody className="divide-y divide-gray-100 text-[15px] text-gray-700 text-center">
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-4 py-3 text-left font-medium">平庸 (Milquetoast)</td><td>300</td><td>11</td><td>10</td><td>12</td><td>10</td><td>9</td><td>8</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-4 py-3 text-left font-medium">唯一生还者 (Lone Survivor)</td><td>420</td><td>14</td><td>11</td><td>11</td><td>10</td><td>7</td><td>7</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-4 py-3 text-left font-medium">悲惨童年 (Troubled Childhood)</td><td>360</td><td>9</td><td>14</td><td>9</td><td>13</td><td>6</td><td>9</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-4 py-3 text-left font-medium">暴力过去 (Violent Past)</td><td>180</td><td>12</td><td>11</td><td>15</td><td>9</td><td>6</td><td>7</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-4 py-3 text-left font-medium">专家 (Professional)</td><td>240</td><td>9</td><td>12</td><td>9</td><td>15</td><td>7</td><td>8</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-4 py-3 text-left font-medium">退役军人 (Military Veteran)</td><td>320</td><td>10</td><td>10</td><td>14</td><td>13</td><td>7</td><td>6</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-4 py-3 text-left font-medium">贵族后裔 (Noble Scion)</td><td>540</td><td>7</td><td>8</td><td>9</td><td>13</td><td>14</td><td>9</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-4 py-3 text-left font-medium">残酷命运 (Cruel Fate)</td><td>500</td><td>10</td><td>12</td><td>10</td><td>9</td><td>5</td><td>14</td></tr>
                     <tr className="hover:bg-gray-50 transition-colors"><td className="px-4 py-3 text-left font-medium">无用之人 (Waste of Skin)</td><td>10</td><td>10</td><td>9</td><td>10</td><td>9</td><td>7</td><td>9</td></tr>
                   </tbody>
                 </table>
               </div>

               {/* Stats */}
               <h3 id="section-stats" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 <Target className="text-sspai-red" /> 属性
               </h3>
               <p className="text-gray-700 mb-6">
               ...
               {/* Basic Combat */}
               <h2 id="section-basic-combat" className="text-3xl mt-16 mb-8 group cursor-pointer text-black border-b pb-4 flex items-center gap-2">
                  <span className="text-sspai-red opacity-0 group-hover:opacity-100 transition-opacity -ml-6 w-6 text-center font-normal">#</span>
                  基础战斗
               </h2>
               <p className="text-gray-700 mb-8">
               ...
               <h3 id="section-stamina" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 精力 (Stamina)
               </h3>
               <p className="text-gray-700 mb-6">
               ...
               <h3 id="section-lock-on" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 锁定 (Lock-On)
               </h3>
               <p className="text-gray-700 mb-6">
               ...
               <h3 id="section-attacks" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h2 id="section-advanced-combat" className="text-3xl mt-16 mb-8 group cursor-pointer text-black border-b pb-4 flex items-center gap-2">
                  <span className="text-sspai-red opacity-0 group-hover:opacity-100 transition-opacity -ml-6 w-6 text-center font-normal">#</span>
                  进阶战斗
               </h2>
               <p className="text-gray-700 mb-8">
               ...
               <h3 id="section-weapon-transformation" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-beasthood" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 兽性 (Beasthood)
               </h3>
               <p className="text-gray-700 mb-6">
               ...
               <h3 id="section-status-ailments" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <div className="overflow-x-auto mb-10">
                 <table className="w-full text-left border-collapse min-w-[600px] bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200">
                   <thead className="bg-gray-50 text-gray-700 text-sm tracking-wider">
                     <tr>
                       <th className="px-4 py-3 border-b border-gray-200 font-bold">异常状态</th>
                       <th className="px-4 py-3 border-b border-gray-200 font-bold">效果</th>
                       <th className="px-4 py-3 border-b border-gray-200 font-bold">治疗方法</th>
                     </tr>
                   </thead>
                   <tbody className="divide-y divide-gray-100 text-[15px] text-gray-700">
                     <tr className="hover:bg-gray-50 transition-colors">
               ...
               <h2 id="section-walkthrough" className="text-3xl mt-16 mb-8 group cursor-pointer text-black border-b pb-4 flex items-center gap-2">
                  <span className="text-sspai-red opacity-0 group-hover:opacity-100 transition-opacity -ml-6 w-6 text-center font-normal">#</span>
                  流程攻略 (Walkthrough)
               </h2>
               <p className="text-gray-700 mb-8">
               ...
               <h3 id="section-iosefkas-clinic" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-hunters-dream" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 猎人梦境 (Hunter's Dream)
               </h3>
               <p className="text-gray-700 mb-6">
               ...
               <div className="overflow-x-auto mb-8">
                 <table className="w-full text-left border-collapse min-w-[600px] bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200">
                   <thead className="bg-gray-50 text-gray-700 text-sm tracking-wider">
                     <tr>
                       <th className="px-4 py-3 border-b border-gray-200 font-bold">名称</th>
                       <th className="px-4 py-3 border-b border-gray-200 font-bold">说明</th>
                     </tr>
                   </thead>
                   <tbody className="divide-y divide-gray-100 text-[15px] text-gray-700">
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-4 py-3 font-medium text-gray-900">锯肉刀 (Saw Cleaver)</td>
                       <td className="px-4 py-3">一把短锯，翻开后射程更远，同时保持单手操作</td>
                     </tr>
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-4 py-3 font-medium text-gray-900">猎人斧 (Hunter Axe)</td>
                       <td className="px-4 py-3">一把短斧，伸长手柄可增加攻击距离，但需要双手操作</td>
                     </tr>
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-4 py-3 font-medium text-gray-900">螺纹手杖 (Threaded Cane)</td>
                       <td className="px-4 py-3">一把可以变成鞭子的手杖，在保持单手操作的同时允许进行大范围攻击</td>
                     </tr>
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-4 py-3 font-medium text-gray-900">猎人手枪 (Hunter Pistol)</td>
                       <td className="px-4 py-3">一把快速准确的手枪，非常适合反击（枪反）敌人</td>
                     </tr>
                     <tr className="hover:bg-gray-50 transition-colors">
                       <td className="px-4 py-3 font-medium text-gray-900">猎人喇叭枪 (Hunter Blunderbuss)</td>
               ...
               <h3 id="section-1st-floor-sickroom" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 1楼病房 (1st Floor Sickroom)
               </h3>
               <div className="bg-blue-50 p-5 rounded-lg border border-blue-100 mb-8">
                 <h4 className="font-bold text-blue-800 mb-2">如何使用地图：</h4>
               ...
               <h3 id="section-central-yharnam" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <p className="text-gray-700 mb-6">
                 当你启动电梯时，这会带你来到刚才所在的大桥的另一侧，你可以轻松解决掉持盾猎人（shielded Huntsman）和猎人的仆从（Huntsman's Minion）。现在你可以走附近的楼梯，用枪击小心地引过来一个大型猎人（Large Huntsman）以降低难度，然后拾取附近的 <strong>勇敢猎人的印记 x2</strong>（Bold Hunter's Mark x2）。

               </p>
               <p className="text-gray-700 mb-8">
                 如果你继续上楼梯，你将到达第二个Boss的区域，但<strong>不要进去</strong>。相反，使用一个 <strong>狂人的知识</strong>（Madman's Knowledge），然后穿过桥回到电梯，并使用提灯。


               </p>
               <h3 id="section-hunters-dream-return" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 猎人梦境 (Hunter's Dream)
               </h3>
               <p className="text-gray-700 mb-6">
                 狂人的知识提供洞察力（Insight），由你当前血之回响下方的眼睛图标表示，它会唤醒人偶（Doll），让你能够用血之回响兑换等级。

               </p>
               <p className="text-gray-700 mb-8">
                 在这里时，你还应该在台阶上与信使（Messengers）交谈，获取 <strong>召唤钟</strong>（Beckoning Bell）和 <strong>静息空白</strong>（Silencing Blank），这两者都用于游戏的多人模式。然后进入建筑内，储存任何你不想使用的物品。别忘了检查桌子以修理你的武器，并用 <strong>血石碎片</strong>（Blood Stone Shards）强化它们以增加伤害。


               </p>
               <h3 id="section-central-yharnam-cont" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 雅南中心 继续 (Central Yharnam Cont.)
               </h3>
               <p className="text-gray-700 mb-8">
                 返回雅南中心提灯，穿过黑暗的房子上楼来到主桥，解决掉兽化人群。这次你要在桥上向左走，干掉一些腐肉乌鸦（Carrion Crows）和一个猎人的仆从，进入前方的 Boss 区域。


               </p>
               <h3 id="section-giant-bridge" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 大桥 (Giant Bridge)
               </h3>

               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：神职人员野兽</span>
                 <a href="#boss-cleric-beast" onClick={(e) => scrollToSection(e, 'boss-cleric-beast')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>

               <p className="text-gray-700 mb-8">
                 确保你拾取了 <strong>水银子弹 x10</strong>（Quicksilver Bullets x10）并点亮了大桥提灯，然后返回猎人梦境升级、修理你的武器，如果你还没有强化武器的话，也一并强化。


               </p>
               <h3 id="section-central-yharnam-cont-2" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 雅南中心 继续 (Central Yharnam Cont.)
               </h3>
               <p className="text-gray-700 mb-6">
                 返回雅南中心提灯，走左边的楼梯去解决猎人的仆从，然后乘坐电梯到达另一座桥。当你向前走时，一群敌人会发动攻击，但你真正需要小心的是从桥尽头推下的燃烧的巨石。躲在桥上的一个阳台区域来避开巨石，然后解决掉剩下的敌人。

               </p>
               <p className="text-gray-700 mb-8">
                 上楼梯再次击败猎人的仆从和持盾猎人，继续上楼梯，无视右侧不会主动攻击你的敌人，进入 <strong>欧顿之墓</strong>（Tomb of Oedon）。


               </p>
               <h3 id="section-central-yharnam-sewers" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 <Map className="text-sspai-red" /> 亚南中心 - 下水道
               </h3>
               ...
               <div className="bg-red-50 p-5 rounded-lg border border-red-100 mb-6">
                 ...
                 <div className="mt-3 pt-3 border-t border-red-200 text-sm font-medium text-red-800">
                   掉落：鹅卵石 x1-2，兽化药丸，解毒药
                 </div>
               </div>

               <p className="text-gray-700 mb-6">
                 往下看下方的横梁，找到一个带有<strong>血石碎片</strong>的横梁，然后跳下去，沿着下水道往回走，进入你扔下尸体的那个房间。经过所有小船走到房间尽头，击败两只迷宫老鼠，从尸体上拾取<strong>狂人的知识</strong>。现在你可以返回上一个区域，爬上右侧的梯子到达上层。
               ...
               <div className="bg-red-50 p-5 rounded-lg border border-red-100 mb-6">
                 ...
                 <p className="text-red-700 text-sm m-0">
                   就像《黑暗之魂》中的老鼠一样，除非成群出现，否则这些敌人构不成什么威胁。当它们后退时要小心，因为这通常表明它们准备猛扑你，当它们用后腿站立时也要注意它们的砸击。
               ...
               <p className="text-gray-700 mb-6">
                 由于你现在位于扔下尸体的区域上方，你可以从两侧跳下，拾取尸体上的物品（<strong>血石碎片</strong> + <strong>锯矛</strong>）。最后你可以返回下水道，继续前进到一个大房间，里面有一些腐烂的尸体聚集在一个物品周围，但现在你先要爬长梯子离开下水道。


               </p>
               <p className="text-gray-700 mb-6">
                 向右转，击杀四只食腐乌鸦，它们守卫着附近尸体上的<strong>狂人的知识</strong>。然后过桥，解决另一个猎人的走狗（砖哥）。这里的梯子通向一扇锁着的门，你可以用附近的拉杆打开它，从而开启通往喷泉广场的捷径。然后与窗户对话，遇到一个小女孩。这个小女孩（仅被称为维奥拉的女儿）会要求你寻找她的母亲，并把<strong>小音乐盒</strong>交给你。


               </p>
               <p className="text-gray-700 mb-6">
                 走右侧的楼梯，找到正在火堆旁敲击大型双开门的猎人的走狗，然后拾取<strong>火把</strong>（建议装备上）和<strong>燃烧瓶 x4</strong>。在广场的另一侧，击杀守卫<strong>油壶 x2</strong>的三只食腐乌鸦，然后返回楼梯并向右转，在关闭的门旁找到一个<strong>冷血露(1)</strong>。


               </p>
               <p className="text-gray-700 mb-6">
                 下一个庭院有三只狂犬和一些猎人，包括一个火枪手，如果你贸然冲进去会很难对付。我建议走到台阶顶部，用枪声引过来一只狂犬，退回到安全的地方击败它，然后对其他敌人重复这个过程。清理完区域后，你可以拾取<strong>采血瓶 x6</strong>，然后走楼梯到一座桥，向左转在一些雕像后面找到一个<strong>血石碎片</strong>。


               </p>
               <p className="text-gray-700 mb-6">
                 朝着桥上的天灾兽走去，但不要与它们交战，而是走左侧的楼梯进入一个俯瞰火堆的区域。拾取悬挂在边缘尸体上的<strong>鹅卵石 x10</strong>，在附近沙袋后面拾取一个<strong>血石碎片</strong>，在一些箱子后面的小巷里拾取一个<strong>血石碎片</strong>，然后继续打破箱子跳入下水道。


               </p>
               <p className="text-gray-700 mb-6">
                 顺着壁架跳下进入下水道，确保你跳到左侧，在那里你会遇到一个朝你走来的大型猎人。解决他后，过桥对付另一个，然后再过最后一座桥对付最后一个。在清理完上层的这三个敌人后，你可以往下看下方的横梁，找到一个<strong>浓稠冷血(5)</strong>，然后小心地跳到下方的迷宫老鼠身上。


               </p>
               <p className="text-gray-700 mb-6">
                 你首先要解决身后的迷宫老鼠，因为你不想被它们偷袭，然后前往下水道的出口，向左看，会发现一个大型猎人守卫着<strong>猎人套装</strong>。


               </p>
               <p className="text-gray-700 mb-6">
                 装备上新的护甲套装，从下水道原路返回到主桥，快速跑过天灾兽，走左侧的楼梯进入黑暗房屋的二楼。在拾取<strong>冷血露(1)</strong>之前，确保杀死屋里的两个猎人，然后转过身，你会发现天灾兽卡在了门里，这样你就可以用蓄力攻击轻松杀死它们。现在你可以返回俯瞰火堆的区域跳下，走通往喷泉广场的路径，然后顺着维奥拉女儿附近的梯子再次到达下水道。


               </p>
               <p className="text-gray-700 mb-6">
                 跳下并小心地杀死身后的食腐乌鸦，然后解决所有守卫着<strong>水银子弹 x10</strong>的腐烂尸体（它们守着它就像某种宝藏一样），接着沿着下水道继续前进，遇到另外三具腐烂尸体。一定要检查那个有一个腐烂尸体以及一个<strong>血石碎片</strong>的小壁龛，然后爬上隧道右侧的梯子到达另一座桥。
               ...
               <div className="bg-red-50 p-5 rounded-lg border border-red-100 mb-6">
                 ...
                 <p className="text-red-700 text-sm m-0">
                   虽然这些敌人经常看起来像死了一样，但实际上它们只是在埋伏等你靠近。虽然移动缓慢，但它们仍然可以向你猛扑或呕吐，所以要小心。你还需要一把能向下劈砍的武器，因为像螺纹手杖的蓄力攻击这样的招式会直接从它们头顶掠过。
               ...
               <p className="text-gray-700 mb-6">
                 忽略桥梁，进入附近的建筑激活电梯（这通向黑暗房屋附近的猎人的走狗，以及通往提灯的另一条捷径），然后从梯子爬下去。你旁边的隧道尽头有一只食人猪，但如果趁它咆哮时冲过去，你可以绕到它身后进行蓄力攻击使其硬直，然后进行内脏暴击。现在你可以拾取<strong>锯肉刀猎人徽章</strong>和<strong>冷血露(2)</strong>，然后从隧道的另一端出去并爬上另一个梯子。
               ...
               <div className="bg-red-50 p-5 rounded-lg border border-red-100 mb-8">
                 ...
                 <p className="text-red-700 text-sm m-0">
                   虽然它们看起来很可怕，但它们的臀部有一个非常大的弱点。最好的方法是从背后用完全蓄力的攻击使其硬直，然后对它的后部进行内脏暴击，场面相当残暴。你必须呆在它们后面，因为它们的冲锋攻击很可能会秒杀你。
               ...
               <h3 id="section-tomb-of-oedon" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 欧顿之墓 (Tomb of Oedon)
               </h3>

               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：神父加斯科因</span>
                 <a href="#boss-father-gascoigne" onClick={(e) => scrollToSection(e, 'boss-father-gascoigne')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>

               <h3 id="section-npc-quests-1" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h4 className="text-xl mt-6 mb-4 font-bold text-gray-800">
                 1楼病房 (1st Floor Sickroom)
               </h4>
               <p className="text-gray-700 mb-6">
               ...
               <h3 id="section-cathedral-ward" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 大教堂区 (Cathedral Ward)
               </h3>
               ...
               <h3 id="section-cathedral-ward-cont" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-npc-quests-2" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h4 id="section-tomb-of-oedon-cont" className="text-xl mt-6 mb-4 font-bold text-gray-800">
                 欧顿之墓 (Tomb of Oedon)
               </h4>
               <p className="text-gray-700 mb-6">
               ...
               <h4 id="section-cathedral-ward-cont-2" className="text-xl mt-6 mb-4 font-bold text-gray-800">
                 大教堂区 继续 (Cathedral Ward Cont.)
               </h4>
               <p className="text-gray-700 mb-6">
               ...
               <h3 id="section-grand-cathedral" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 大教堂 (Grand Cathedral)
               </h3>

               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：代理人阿梅利亚</span>
                 <a href="#boss-vicar-amelia" onClick={(e) => scrollToSection(e, 'boss-vicar-amelia')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>

               <h3 id="section-npc-quests-3" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-old-yharnam" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 旧雅南 (Old Yharnam)
               </h3>
               ...
               <h3 id="section-church-of-the-good-chalice" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 良杯教会 (Church of the Good Chalice)
               </h3>

               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：渴血神兽</span>
                 <a href="#boss-blood-starved-beast" onClick={(e) => scrollToSection(e, 'boss-blood-starved-beast')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>

               <h3 id="section-hemwick-charnel-lane" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-forbidden-woods" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-forbidden-grave" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 禁忌之墓 (Forbidden Grave)
               </h3>

               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：雅南暗影</span>
                 <a href="#boss-shadow-of-yharnam" onClick={(e) => scrollToSection(e, 'boss-shadow-of-yharnam')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>

               <h3 id="section-byrgenwerth" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 拜尔金沃斯 (Byrgenwerth)
               </h3>
               ...
               <h3 id="section-moonside-lake" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 月畔湖 (Moonside Lake)
               </h3>

               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：愚钝蜘蛛罗姆</span>
                 <a href="#boss-rom-the-vacuous-spider" onClick={(e) => scrollToSection(e, 'boss-rom-the-vacuous-spider')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>

               <h3 id="section-npc-quests-5" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-witchs-abode" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 女巫住所 (Witch's Abode)
               </h3>

               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：汉威克女巫</span>
                 <a href="#boss-the-witch-of-hemwick" onClick={(e) => scrollToSection(e, 'boss-the-witch-of-hemwick')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>
               ...
               <h3 id="section-hypogean-gaol" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-graveyard-of-the-darkbeast" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 黑兽墓地 (Graveyard of the Darkbeast)
               </h3>

               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：黑兽帕尔</span>
                 <a href="#boss-darkbeast-paarl" onClick={(e) => scrollToSection(e, 'boss-darkbeast-paarl')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>

               <h3 id="section-npc-quests-part-4" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-healing-church-workshop" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-forsaken-cainhurst-castle" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-martyr-logarius" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <div className="bg-red-50 p-6 rounded-xl border border-red-100 mb-8">
                 ...
                 <div className="mb-6">
                   <strong className="text-red-900 block mb-3">烈士洛格力斯的攻击列表：</strong>
                   <div className="overflow-x-auto">
                     <table className="w-full text-left border-collapse bg-white/50 rounded-lg overflow-hidden">
                       <thead className="bg-red-100/50 text-red-900 text-sm">
                         <tr>
                       ...
                       <tbody className="divide-y divide-red-100 text-sm">
                         <tr><td colSpan="3" className="px-4 py-2 font-bold bg-red-50/50 text-red-900">第 1 阶段</td></tr>
                         <tr>
                         ...
                         <tr><td colSpan="3" className="px-4 py-2 font-bold bg-red-50/50 text-red-900">第 2 阶段</td></tr>
                         <tr>
               ...
               <h3 id="section-yahargul-unseen-village" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-yahargul-chapel" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-advent-plaza" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 降临广场 (Advent Plaza)
               </h3>

               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：重生古神祇</span>
                 <a href="#boss-the-one-reborn" onClick={(e) => scrollToSection(e, 'boss-the-one-reborn')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>
               ...
               <h3 id="section-npc-quests-6" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h4 id="section-vileblood-queens-chambers" className="text-xl mt-8 mb-4 font-bold text-gray-800">
               ...
               <h4 id="section-cathedral-ward-3" className="text-xl mt-8 mb-4 font-bold text-gray-800">
                 大教堂区 (Cathedral Ward)
               </h4>
               <p className="text-gray-700 mb-6">
               ...
               <h3 id="section-lecture-building-1f" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-nightmare-frontier" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-amygdalas-chamber" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 亚米达拉的巢穴 (Amygdala's Chamber)
               </h3>
               
               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：亚米达拉</span>
                 <a href="#boss-amygdala" onClick={(e) => scrollToSection(e, 'boss-amygdala')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>

               <h3 id="section-lecture-building-2f" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-upper-cathedral-ward" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-lumenflower-gardens" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 明花花园 (Lumenflower Gardens)
               </h3>
               
               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：神圣使者</span>
                 <a href="#boss-celestial-emissary" onClick={(e) => scrollToSection(e, 'boss-celestial-emissary')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>

               <h3 id="section-altar-of-despair" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：宇宙之女伊碧塔丝</span>
                 <a href="#boss-ebrietas-daughter-of-the-cosmos" onClick={(e) => scrollToSection(e, 'boss-ebrietas-daughter-of-the-cosmos')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>

               <h3 id="section-npc-quests-7" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-nightmare-of-mensis-1" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：噩梦之主密寇拉什</span>
                 <a href="#boss-micolash-host-of-nightmares" onClick={(e) => scrollToSection(e, 'boss-micolash-host-of-nightmares')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>

               <h2 id="section-endings" className="text-3xl mt-16 mb-8 group cursor-pointer text-black border-b pb-4 flex items-center gap-2">
                  <span className="text-sspai-red opacity-0 group-hover:opacity-100 transition-opacity -ml-6 w-6 text-center font-normal">#</span>
               ...
               <div className="grid md:grid-cols-3 gap-6 mb-8">
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-100">
                   <h4 className="font-bold text-lg mb-2 text-gray-900">结局 1 (Ending 1)</h4>
                   <p className="text-sm text-gray-600 m-0">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-100">
                   <h4 className="font-bold text-lg mb-2 text-gray-900">结局 2 (Ending 2)</h4>
                   <p className="text-sm text-gray-600 m-0">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-100">
                   <h4 className="font-bold text-lg mb-2 text-gray-900">结局 3 (Ending 3)</h4>
                   <p className="text-sm text-gray-600 m-0">
               ...
               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：第一猎人杰尔曼</span>
                 <a href="#boss-gehrman-the-first-hunter" onClick={(e) => scrollToSection(e, 'boss-gehrman-the-first-hunter')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>

               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：月之妖气 / 月神</span>
                 <a href="#boss-moon-presence" onClick={(e) => scrollToSection(e, 'boss-moon-presence')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>

               {/* The Old Hunters Walkthrough */}
               <h2 id="section-old-hunters-walkthrough" className="text-3xl mt-16 mb-8 group cursor-pointer text-black border-b pb-4 flex items-center gap-2">
                 <span className="text-sspai-red opacity-0 group-hover:opacity-100 transition-opacity -ml-6 w-6 text-center font-normal">#</span>
               ...
               <h3 id="section-hunters-nightmare" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：丑陋的野兽路德维希 / 圣剑路德维希</span>
                 <a href="#boss-ludwig-the-accursed-ludwig-the-holy-blade" onClick={(e) => scrollToSection(e, 'boss-ludwig-the-accursed-ludwig-the-holy-blade')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>
               ...
               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：失败者</span>
                 <a href="#boss-living-failures" onClick={(e) => scrollToSection(e, 'boss-living-failures')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>
               ...
               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：星辰钟塔的玛丽亚女士</span>
                 <a href="#boss-lady-maria-of-the-astral-clocktower" onClick={(e) => scrollToSection(e, 'boss-lady-maria-of-the-astral-clocktower')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>
               ...
               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：科斯的高儿</span>
                 <a href="#boss-orphan-of-kos" onClick={(e) => scrollToSection(e, 'boss-orphan-of-kos')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>
               ...
               <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 mb-8 flex items-center justify-between">
                 <span className="font-bold text-gray-800 flex items-center gap-2"><Swords size={20} className="text-sspai-red" />即将遭遇 Boss：第一任主教劳伦斯</span>
                 <a href="#boss-laurence-the-first-vicar" onClick={(e) => scrollToSection(e, 'boss-laurence-the-first-vicar')} className="text-sspai-red hover:text-red-700 font-medium text-sm flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full transition-colors">查看详细攻略 <ChevronRight size={16} /></a>
               </div>

               <h3 id="section-npc-quests-iosefka" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <div className="mt-4 pt-3 border-t border-gray-200 font-bold text-gray-900 mb-8">
                 <p className="mb-2">🎁 掉落 (Drops):</p>
                 <ul className="list-disc list-inside ml-4 font-normal text-gray-700">
               ...
               <h3 id="section-npc-quests-gilbert" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-npc-quests-lonely-old-dear" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-npc-quests-eileen" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-npc-quests-viola" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-npc-quests-oedon-dweller" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-npc-quests-alfred" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h3 id="section-npc-quests-arianna" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <p className="text-gray-700 mb-6">
                 ...
                 <h3 id="section-npc-quests-narrow-minded-man" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 ...
                 <h3 id="section-npc-quests-djura" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 ...
                 <h3 id="section-npc-quests-adella" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 ...
                 <h3 id="section-npc-quests-transformed-man" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 ...
                 <h3 id="section-npc-quests-provost-willem" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 ...
                 <h3 id="section-npc-quests-annalise" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 ...
                 <h3 id="section-npc-quests-patches" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 ...
                 <h3 id="section-npc-quests-valtr" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 ...
                 <h3 id="section-npc-quests-simon" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 ...
                 <h3 id="section-npc-quests-ludwig-head" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 ...
                 <h3 id="section-npc-quests-brador" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 ...
                 <h3 id="section-npc-quests-adeline" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 ...
                 <h3 id="section-npc-quests-yamamura" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 ...
                 <h3 id="section-npc-quests-fishing-priest" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <h2 id="section-chalice-dungeons" className="text-3xl mt-16 mb-8 group cursor-pointer text-black border-b pb-4 flex items-center gap-2">
                 <span className="text-sspai-red opacity-0 group-hover:opacity-100 transition-opacity -ml-6 w-6 text-center font-normal">#</span>
                 圣杯地牢 (Chalice Dungeons)
               </h2>
  
               <h3 id="section-pthumerian-labyrinth" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 苏美鲁迷宫 (Pthumerian Labyrinth)
               </h3>
               <p className="text-gray-700 mb-6 italic">- 待补充 (To Be Continued)</p>
  
               <h3 id="section-central-pthumerian-labyrinth" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 中央苏美鲁迷宫 (Central Pthumerian Labyrinth)
               </h3>
               <p className="text-gray-700 mb-6 italic">- 待补充 (To Be Continued)</p>
  
               <h3 id="section-lower-pthumerian-labyrinth" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 下层苏美鲁迷宫 (Lower Pthumerian Labyrinth)
               </h3>
               <p className="text-gray-700 mb-6 italic">- 待补充 (To Be Continued)</p>
  
               <h3 id="section-cursed-pthumerian-defilement" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 受诅咒的苏美鲁污秽 (Cursed Pthumerian Defilement)
               </h3>
               <p className="text-gray-700 mb-6 italic">- 待补充 (To Be Continued)</p>
  
               <h3 id="section-pthumeru-ihyll" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 苏美鲁伊忽尔 (Pthumeru Ihyll)
               </h3>
               <p className="text-gray-700 mb-6 italic">- 待补充 (To Be Continued)</p>
  
               <h3 id="section-hintertomb" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 内墓穴 (Hintertomb)
               </h3>
               <p className="text-gray-700 mb-6 italic">- 待补充 (To Be Continued)</p>
  
               <h3 id="section-lower-hintertomb" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 下层内墓穴 (Lower Hintertomb)
               </h3>
               <p className="text-gray-700 mb-6 italic">- 待补充 (To Be Continued)</p>
  
               <h3 id="section-ailing-loran" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 衰弱的罗伦城 (Ailing Loran)
               </h3>
               <p className="text-gray-700 mb-6 italic">- 待补充 (To Be Continued)</p>
  
               <h3 id="section-lower-ailing-loran" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 下层衰弱的罗伦城 (Lower Ailing Loran)
               </h3>
               <p className="text-gray-700 mb-6 italic">- 待补充 (To Be Continued)</p>
  
               <h3 id="section-isz-gravestone" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 伊兹墓碑 (Isz Gravestone)
               </h3>
               <p className="text-gray-700 mb-6 italic">- 待补充 (To Be Continued)</p>
  
               {/* Items & Equipment Section */}
               <h2 id="section-items-equipment" className="text-3xl mt-16 mb-8 group cursor-pointer text-black border-b pb-4 flex items-center gap-2">
                 <span className="text-sspai-red opacity-0 group-hover:opacity-100 transition-opacity -ml-6 w-6 text-center font-normal">#</span>
               ...
               <h3 id="section-consumables" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 消耗品 (Consumables)
               </h3>
               ...
               <div className="space-y-6">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-red-900 text-lg mb-2">采血瓶 (Blood Vial)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>恢复 40% 的生命值</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Quicksilver Bullets */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-900 text-lg mb-2">水银子弹 (Quicksilver Bullets)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>用于发射左手武器</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-red-900 text-lg mb-2">约瑟夫卡的采血瓶 (Iosefka's Blood Vial)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>恢复 70% 的生命值</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由约瑟夫卡给予</li>
                 ...
                 {/* Blood of Arianna */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-red-900 text-lg mb-2">阿丽安娜的血液 (Blood of Arianna)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>恢复 25% 的生命值并提高精力恢复速度</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由妓女阿丽安娜给予</li>
                 ...
                 {/* Blood of Adella */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-red-900 text-lg mb-2">阿德拉的血液 (Blood of Adella)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>恢复 25% 的生命值，并在几秒钟内持续恢复生命</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由修女阿德拉给予</li>
                 ...
                 {/* Blood of Adeline */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-red-900 text-lg mb-2">爱德琳的血液 (Blood of Adeline)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>恢复 50% 的生命值，并在几秒钟内持续恢复生命</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由爱德琳给予</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>清除毒素积累并治愈慢毒</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>增加你的伤害 60 秒，基于你的兽性和野兽量表</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Sedative */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-blue-900 text-lg mb-2">镇静剂 (Sedative)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>清除狂暴积累</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由孤独的老妇人给予</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>使你部分透明 30 秒</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Lead Elixir */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-700 text-lg mb-2">铅之灵药 (Lead Elixir)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>减慢你的步行和跑步速度，以避免在 30 秒内受到攻击而硬直</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由巨大的迷失之子掉落</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>根据你的奥术属性造成火焰伤害</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>根据你的奥术属性造成火焰伤害，同时将燃烧瓶扔在你身后</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>使敌人对下一次受到的火焰伤害变得脆弱</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-red-900 text-lg mb-2">刺鼻的血丸 (Pungent Blood Cocktail)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>用它的气味吸引敌人，让它们完全忽略你</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由行刑者掉落</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>在 1 分钟内使治疗效果无效</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Throwing Knife */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">飞刀 (Throwing Knife)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>根据你的力量造成物理伤害</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由迷宫老鼠掉落</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>根据敌人的抗性造成慢毒积累</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Pebble */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-600 text-lg mb-2">鹅卵石 (Pebble)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>吸引一个敌人的注意</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>为每次攻击增加 80 点固定火焰伤害</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>为每次攻击增加 80 点固定闪电伤害</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由劫持者掉落</li>
                 ...
                 {/* Bone Marrow Ash */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-700 text-lg mb-2">骨髓灰 (Bone Marrow Ash)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>增加你下一发水银子弹的伤害，仅限左手武器</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>刺伤敌人以使其困惑几秒钟</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由吸脑怪掉落</li>
                 ...
                 {/* Bold Hunter's Mark */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-blue-800 text-lg mb-2">勇敢猎人的印记 (Bold Hunter's Mark)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>返回提灯且不丢失血之回响</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由腐烂的尸体掉落</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>丢下一枚硬币以创建可见的路径</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由猎人的仆从掉落</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>发出明亮的光，但会稍微影响精力恢复</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Monocular */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">单筒望远镜 (Monocular)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>观察远处的物体，可用于瞄准远程武器和消耗品</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>在短时间内分散神父加斯科因的注意力</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由维奥拉的女儿给予</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>使用后获得 350 / 500 / 1000 血之回响</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由寄生幼虫掉落</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>使用后获得 1200 / 1500 / 1800 血之回响</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由爬行者掉落</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-red-900 text-lg mb-2">狂暴冷血 (7-9) (Frenzied Coldblood)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>使用后获得 2000 / 3000 / 5000 血之回响</p>
                 </div>

                 {/* Kin Coldblood (10-12) */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-purple-800 text-lg mb-2">眷属冷血 (10-12) (Kin Coldblood)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>使用后获得 8000 / 10000 / 20000 血之回响</p>
                 </div>

                 {/* Great One Coldblood */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-yellow-800 text-lg mb-2">古神冷血 (Great One Coldblood)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>使用后获得 40000 血之回响</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>使用后获得 50000 血之回响</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>在深度 5 的圣杯地牢中找到</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>获得 1 灵视 (Insight)</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>在整个血源诅咒中都能找到</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>获得 2 灵视 (Insight)</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>在拜尔金沃斯中找到</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-red-900 text-lg mb-2">三分之一脐带 (One Third of Umbilical Cord)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>获得 3 灵视 (Insight)（集齐3个并在最终Boss前使用可触发真结局）</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>在废弃旧工厂中找到</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>获得 1 灵视 (Insight)（可用于向血族女王献上）</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>使用后获得红宝石血宝石（或交还给小女孩）</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>使用以获得金色血宝石</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由代理人阿梅利亚掉落</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>使用以获得泪水血宝石</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由人偶在交换小发饰后给予</li>
               ...
               <h3 id="section-hunter-tools" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 猎人工具 (Hunter Tools)
               </h3>
               ...
               <div className="space-y-6">
                 {/* Old Hunter Bone */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">老猎人骨头 (Old Hunter Bone)</h4>
                   <p className="text-gray-700 text-sm mb-2"><strong>需求：</strong> 15 奥术 (Arcane)</p>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>增加你的翻滚和滑步速度</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>在废弃旧工厂中找到</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-2"><strong>需求：</strong> 25 奥术 (Arcane)</p>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>造成受你奥术属性加成的闪电伤害</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-2"><strong>需求：</strong> 15 奥术 (Arcane)</p>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>为每次攻击增加 80 点固定的奥术伤害</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>在拜尔金沃斯豪宅的顶层找到</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-2"><strong>需求：</strong> 16 奥术 (Arcane)</p>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>造成受你奥术属性加成的奥术伤害</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-2"><strong>需求：</strong> 18 奥术 (Arcane)</p>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>造成受你奥术属性加成的奥术伤害（可用于枪反或打出背刺硬直）</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* A Call Beyond */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-blue-800 text-lg mb-2">远方的呼唤 (A Call Beyond)</h4>
                   <p className="text-gray-700 text-sm mb-2"><strong>需求：</strong> 40 奥术 (Arcane)</p>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>造成受你奥术属性加成的巨大奥术伤害（群星爆炸）</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-2"><strong>需求：</strong> 20 奥术 (Arcane)</p>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>治疗自己和周围的盟友，治疗量受你的奥术属性加成，并治愈异常状态</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-2"><strong>需求：</strong> 15 奥术 (Arcane)</p>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>击倒周围的敌人，并弹开飞行道具</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Madaras Whistle */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-red-900 text-lg mb-2">马达拉斯的哨子 (Madaras Whistle)</h4>
                   <p className="text-gray-700 text-sm mb-2"><strong>需求：</strong> 18 血质 (Bloodtinge)</p>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>召唤巨蛇，造成受你血质属性加成的伤害（注意巨蛇也会伤害到你）</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-2"><strong>需求：</strong> 20 奥术 (Arcane)</p>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>发射追踪怨灵，造成受你奥术属性加成的奥术伤害</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-2"><strong>需求：</strong> 30 奥术 (Arcane)</p>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>投掷诅咒头骨，造成受你奥术属性加成的奥术伤害</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Messenger's Gift */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-700 text-lg mb-2">信使的礼物 (Messenger's Gift)</h4>
                   <p className="text-gray-700 text-sm mb-2"><strong>需求：</strong> 10 奥术 (Arcane)</p>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>将你变成一个信使（用于伪装）</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
               ...
               <h3 id="section-multiplayer-covenant" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <div className="space-y-6">
                 {/* Vermin */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-red-900 text-lg mb-2">害虫 (Vermin)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>捏碎以提高你在联盟契约中的排名</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>查看该隐赫斯特血族契约的排行榜</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>查看联盟契约的排行榜</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Beckoning Bell */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">召唤钟 (Beckoning Bell)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>消耗 1 灵视来召唤盟友，但每增加一个盟友，Boss的生命值也会相应增加</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>摇响以作为盟友被其他玩家召唤</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>在猎人梦境的灵视信使处购买 (1 灵视)</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>摇响以作为敌对入侵者被召唤到其他玩家的世界</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>在猎人梦境的灵视信使处购买 (1 灵视)</li>
                 ...
                 {/* Silencing Blank */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-600 text-lg mb-2">静默空白 (Silencing Blank)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>中断共鸣，或将召唤的盟友送回他们的世界，或结束自己的入侵返回原世界</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>获得 1 灵视后，由猎人梦境的信使给予</li>
                 ...
                 {/* Hunter's Mark */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-900 text-lg mb-2">猎人的印记 (Hunter's Mark)</h4>
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>返回提灯，但代价是失去你所有的血之回响</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>默认自带</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   ...
                   <p className="text-gray-700 text-sm mb-3"><strong>效果：</strong>阅读和评价他人的留言，或留下自己的信息</p>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由猎人梦境的信使给予</li>
               ...
               <h3 id="section-materials" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 升级与仪式材料 (Materials)
               </h3>
               ...
               <div className="space-y-6">
                 {/* Blood Stone Shard */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-700 text-lg mb-2">血石碎片 (Blood Stone Shard)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">双子血石碎片 (Twin Blood Stone Shards)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Blood Stone Chunk */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-900 text-lg mb-2">血石块 (Blood Stone Chunk)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Blood Rock */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-red-900 text-lg mb-2">血岩 (Blood Rock)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Arcane Haze */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-blue-500 text-lg mb-2">奥术暗霾 (Arcane Haze)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Sage's Hair */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-600 text-lg mb-2">圣者的头发 (Sage's Hair)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Inflicted Organ */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-red-900 text-lg mb-2">受感染的器官 (Inflicted Organ)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
               ...
               <h3 id="section-key-items" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 关键物品 (Key Items)
               </h3>
               ...
               <div className="space-y-6">
                 ...
                 {/* Iron Door Key */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-700 text-lg mb-2">铁门钥匙 (Iron Door Key)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Hunter Chief Emblem */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">猎人首席徽章 (Hunter Chief Emblem)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Cainhurst Summons */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-red-900 text-lg mb-2">该隐赫斯特的召唤状 (Cainhurst Summons)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Celestial Dial */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-blue-900 text-lg mb-2">天体表盘 (Celestial Dial)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Unopened Summons */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-red-900 text-lg mb-2">未开封的召唤状 (Unopened Summons)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Queenly Flesh */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-red-900 text-lg mb-2">女王的血肉 (Queenly Flesh)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由血族女王安娜丽丝掉落</li>
                 ...
                 {/* Tonsil Stone */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-600 text-lg mb-2">扁桃体石头 (Tonsil Stone)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由蜘蛛帕奇给予</li>
                 ...
                 {/* Yharnam Stone */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">雅南之石 (Yharnam Stone)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由苏美鲁女王雅南掉落</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-blue-800 text-lg mb-2">车间暗霾抽取器 (Workshop Haze Extractor)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
               ...
               <h3 id="section-badges" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
                 徽章 (Badges)
               </h3>
               ...
               <div className="space-y-6">
                 {/* Saw Hunter Badge */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">锯肉刀猎人徽章 (Saw Hunter Badge)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">火药桶帮猎人徽章 (Powder Keg Hunter Badge)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由退休猎人机枪哥掉落</li>
                 ...
                 {/* Old Hunter Badge */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">老猎人徽章 (Old Hunter Badge)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由第一猎人杰尔曼掉落</li>
                 ...
                 {/* Crow Hunter Badge */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">乌鸦猎人徽章 (Crow Hunter Badge)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由乌鸦艾琳掉落</li>
                 ...
                 {/* Spark Hunter Badge */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">火花猎人徽章 (Spark Hunter Badge)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由黑兽帕尔掉落</li>
                 ...
                 {/* Sword Hunter Badge */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">剑之猎人徽章 (Sword Hunter Badge)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由圣职者野兽掉落</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">闪耀剑之猎人徽章 (Radiant Sword Hunter Badge)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>在治愈教会工厂找到</li>
                 ...
                 {/* Wheel Hunter Badge */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">车轮猎人徽章 (Wheel Hunter Badge)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>由血族猎人阿尔弗雷德掉落</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">宇宙之眼守望者徽章 (Cosmic Eye Watcher Badge)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Firing Hammer Badge */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">击铁猎人徽章 (Firing Hammer Badge)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Cainhurst Badge */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">该隐赫斯特徽章 (Cainhurst Badge)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>加入该隐赫斯特血族契约获得</li>
               ...
               <h3 id="section-messenger-items" className="text-2xl mt-12 mb-6 font-bold text-gray-800 flex items-center gap-2">
               ...
               <div className="space-y-6">
                 {/* Brain Fluid */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">脑浆 (Brain Fluid)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 {/* Messenger Top Hat */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">信使高礼帽 (Messenger Top Hat)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>在治愈教会工厂找到</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">破旧的信使高礼帽 (Worn Messenger Top Hat)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>DLC 物品</li>
                 ...
                 {/* Black Messenger Hat */}
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">黑色信使礼帽 (Black Messenger Hat)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">雅南信使礼帽 (Yharnam Messenger Hat)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>DLC 物品</li>
                 ...
                 <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                   <h4 className="font-bold text-gray-800 text-lg mb-2">信使头部绷带 (Messenger Head Bandage)</h4>
                   <div>
                     <strong className="text-gray-800 text-sm">位置：</strong>
                     <ul className="list-disc list-inside ml-4 text-sm text-gray-600 mt-1">
                       <li>DLC 物品</li>
               ...
               {/* Weapons Section */}
               <h2 id="section-weapons" className="text-3xl mt-16 mb-8 group cursor-pointer text-black border-b pb-4 flex items-center gap-2">
                 <span className="text-sspai-red opacity-0 group-hover:opacity-100 transition-opacity -ml-6 w-6 text-center font-normal">#</span>
                 武器 (Weapons)
               </h2>
               ...
               <h3 className="text-xl mt-8 mb-4 font-bold text-gray-800">
                 ...
                 <table className="w-full text-sm text-center">
                   <thead>
                     ...
                     <tr className="border-b border-gray-200 bg-gray-50">
                       ...
                       <th className="py-2 px-3 text-red-900">血质 (Bloodtinge)</th>
               ...
               <div className="bg-white/60 rounded-lg p-3 overflow-x-auto mb-8 border border-gray-200">
                 <h4 className="font-bold text-gray-800 mb-2 text-center">平均物理攻击力提升 (基于力量) (Average Physical Attack Increase - Strength)</h4>
                 <table className="w-full text-sm text-center">
                   <thead>
                     <tr className="border-b border-gray-200 bg-gray-50">
               ...
               <div className="space-y-12">
                 {/* Saw Cleaver */}
                 <div>
                   <h3 id="weapon-saw-cleaver" className="text-2xl mt-8 mb-6 font-bold text-gray-800 flex items-center gap-2">
                     锯肉刀 (Saw Cleaver)
                   </h3>
                   ...
                   <div className="bg-white/60 rounded-lg p-3 overflow-x-auto mb-6 border border-gray-200">
                     <table className="w-full text-sm text-left">
                       ...
                       <tbody>
                         <tr className="border-b border-gray-100">
                           <td className="py-2 px-3 font-medium text-gray-800">普通 (Normal)</td>
                           <td className="py-2 px-3">由信使作为初始武器给予<br/>信使商店 - 1,000 血之回响</td>
                         </tr>
                         <tr className="border-b border-gray-100">
                           <td className="py-2 px-3 font-medium text-gray-800">怪异 (Uncanny)</td>
                           <td className="py-2 px-3">苏美鲁迷宫始源 (Pthumerian Labyrinth Root)</td>
                         </tr>
                         <tr className="border-b border-gray-100">
                           <td className="py-2 px-3 font-medium text-gray-800">失落 (Lost)</td>
                   ...
                   <div className="bg-gray-50 p-3 rounded-lg border border-gray-200 mb-6 flex gap-6 text-sm">
                     ...
                     <div><strong className="text-red-900">血质:</strong> -</div>
                   ...
                   <div className="bg-white/60 rounded-lg p-3 overflow-x-auto mb-6 border border-gray-200">
                     <table className="w-full text-sm text-center">
                       ...
                       <tbody>
                         <tr className="border-b border-gray-100"><td>0</td><td>90</td><td>D</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>1</td><td>99</td><td>D</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>2</td><td>108</td><td>D</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>3</td><td>117</td><td>D</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>4</td><td>126</td><td>D</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>5</td><td>135</td><td>D</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>6</td><td>144</td><td>D</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>7</td><td>153</td><td>D</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>8</td><td>162</td><td>C</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>9</td><td>171</td><td>C</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>10</td><td>180</td><td>C</td><td>D</td><td>-</td><td>C</td></tr>
                       </tbody>
                     </table>
                   </div>
                   ...
                   <div className="grid md:grid-cols-2 gap-6 mb-6">
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       <h4 className="font-bold text-gray-800 mb-2 text-center text-sm">平均物理攻击力提升 (基于技巧)</h4>
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>8 - 25</td><td>1.89</td><td>34</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>1.00</td><td>25</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.22</td><td>11</td></tr>
                         </tbody>
                       </table>
                     </div>
                   </div>
                 ...
                 <div className="pt-8 border-t border-gray-200">
                   <h3 id="weapon-saw-spear" className="text-2xl mb-6 font-bold text-gray-800 flex items-center gap-2">
                     锯矛 (Saw Spear)
                   </h3>
                   ...
                   <div className="bg-white/60 rounded-lg p-3 overflow-x-auto mb-6 border border-gray-200">
                     <table className="w-full text-sm text-center">
                       ...
                       <tbody>
                         <tr className="border-b border-gray-100"><td>0</td><td>85</td><td>D</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>1</td><td>93</td><td>D</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>2</td><td>101</td><td>D</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>3</td><td>109</td><td>D</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>4</td><td>117</td><td>D</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>5</td><td>125</td><td>D</td><td>C</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>6</td><td>133</td><td>D</td><td>C</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>7</td><td>141</td><td>D</td><td>C</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>8</td><td>149</td><td>D</td><td>C</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>9</td><td>157</td><td>D</td><td>C</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>10</td><td>170</td><td>D</td><td>C</td><td>-</td><td>C</td></tr>
                       </tbody>
                     </table>
                   </div>
                   ...
                   <div className="grid md:grid-cols-2 gap-6 mb-6">
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       <h4 className="font-bold text-gray-800 mb-2 text-center text-sm">平均物理攻击力提升 (基于力量)</h4>
                       <table className="w-full text-xs text-center">
                         <thead>
                           <tr className="border-b border-gray-200 bg-gray-50">
                             <th className="py-1 px-2">范围</th>
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>8 - 25</td><td>2.17</td><td>39</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>1.20</td><td>30</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.27</td><td>13</td></tr>
                         </tbody>
                       </table>
                     </div>
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       ...
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>9 - 25</td><td>2.94</td><td>50</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>1.52</td><td>38</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.33</td><td>16</td></tr>
                         </tbody>
                       </table>
                     </div>
                   </div>
                 ...
                 {/* Hunter Axe */}
                 <div className="pt-8 border-t border-gray-200">
                   <h3 id="weapon-hunter-axe" className="text-2xl mb-6 font-bold text-gray-800 flex items-center gap-2">
                     猎人斧 (Hunter Axe)
                   </h3>
                   ...
                   <div className="bg-white/60 rounded-lg p-3 overflow-x-auto mb-6 border border-gray-200">
                     <table className="w-full text-sm text-center">
                       ...
                       <tbody>
                         <tr className="border-b border-gray-100"><td>0</td><td>98</td><td>D</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>1</td><td>107</td><td>D</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>2</td><td>116</td><td>D</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>3</td><td>125</td><td>D</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>4</td><td>134</td><td>D</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>5</td><td>143</td><td>C</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>6</td><td>152</td><td>C</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>7</td><td>161</td><td>C</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>8</td><td>170</td><td>C</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>9</td><td>179</td><td>C</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>10</td><td>196</td><td>B</td><td>D</td><td>-</td><td>C</td></tr>
                       </tbody>
                     </table>
                   </div>
                   ...
                   <div className="grid md:grid-cols-2 gap-6 mb-6">
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       ...
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>10 - 25</td><td>3.63</td><td>58</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>1.76</td><td>44</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.41</td><td>20</td></tr>
                         </tbody>
                       </table>
                     </div>
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       ...
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>8 - 25</td><td>1.82</td><td>31</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>0.96</td><td>24</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.22</td><td>11</td></tr>
                         </tbody>
                       </table>
                     </div>
                 ...
                 {/* 怪兽猎人弯刀 */}
                 <div className="pt-8 border-t border-gray-200">
                   <h3 id="weapon-beasthunter-saif" className="text-2xl mb-6 font-bold text-gray-800 flex items-center gap-2">
                   ...
                   <div className="bg-white/60 rounded-lg p-3 overflow-x-auto mb-6 border border-gray-200">
                     <table className="w-full text-sm text-center">
                       ...
                       <tbody>
                         <tr className="border-b border-gray-100"><td>0</td><td>90</td><td>E</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>1</td><td>99</td><td>E</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>2</td><td>108</td><td>E</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>3</td><td>117</td><td>E</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>4</td><td>126</td><td>E</td><td>C</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>5</td><td>135</td><td>E</td><td>C</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>6</td><td>144</td><td>E</td><td>C</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>7</td><td>153</td><td>E</td><td>C</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>8</td><td>162</td><td>E</td><td>C</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>9</td><td>171</td><td>D</td><td>B</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>10</td><td>180</td><td>D</td><td>B</td><td>-</td><td>C</td></tr>
                       </tbody>
                     </table>
                   </div>
                   ...
                   <div className="grid md:grid-cols-2 gap-6 mb-6">
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       <h4 className="font-bold text-gray-800 mb-2 text-center text-sm">平均物理攻击力提升 (力量)</h4>
                       <table className="w-full text-xs text-center">
                         <thead>
                           <tr className="border-b border-gray-200 bg-gray-50">
                             <th className="py-1 px-2">范围</th>
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>9 - 25</td><td>1.56</td><td>25</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>0.72</td><td>18</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.18</td><td>9</td></tr>
                         </tbody>
                       </table>
                     </div>
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       <h4 className="font-bold text-gray-800 mb-2 text-center text-sm">平均物理攻击力提升 (技巧)</h4>
                       <table className="w-full text-xs text-center">
                         <thead>
                           <tr className="border-b border-gray-200 bg-gray-50">
                             <th className="py-1 px-2">范围</th>
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>11 - 25</td><td>3.79</td><td>53</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>1.76</td><td>44</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.39</td><td>19</td></tr>
                         </tbody>
                       </table>
                     </div>
                   </div>
                 ...
                 {/* 螺纹手杖 */}
                 <div className="pt-8 border-t border-gray-200">
                   <h3 id="weapon-threaded-cane" className="text-2xl mb-6 font-bold text-gray-800 flex items-center gap-2">
                     螺纹手杖 (Threaded Cane)
                   </h3>
                   ...
                   <div className="bg-white/60 rounded-lg p-3 overflow-x-auto mb-6 border border-gray-200">
                     <table className="w-full text-sm text-center">
                       ...
                       <tbody>
                         <tr className="border-b border-gray-100"><td>0</td><td>78</td><td>E</td><td>C</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>1</td><td>85</td><td>E</td><td>C</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>2</td><td>92</td><td>E</td><td>B</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>3</td><td>99</td><td>E</td><td>B</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>4</td><td>106</td><td>E</td><td>B</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>5</td><td>113</td><td>E</td><td>B</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>6</td><td>120</td><td>E</td><td>B</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>7</td><td>127</td><td>E</td><td>B</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>8</td><td>134</td><td>E</td><td>B</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>9</td><td>141</td><td>E</td><td>A</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>10</td><td>156</td><td>E</td><td>A</td><td>-</td><td>B</td></tr>
                       </tbody>
                     </table>
                   </div>
                   ...
                   <div className="grid md:grid-cols-2 gap-6 mb-6">
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       ...
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>8 - 25</td><td>1.17</td><td>21</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>0.64</td><td>16</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.14</td><td>7</td></tr>
                         </tbody>
                       </table>
                     </div>
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       ...
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>10 - 25</td><td>4.00</td><td>64</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>1.96</td><td>49</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.43</td><td>21</td></tr>
                         </tbody>
                       </table>
                     </div>
                   </div>
                 ...
                 {/* 野兽切割刀 */}
                 <div className="pt-8 border-t border-gray-200">
                   <h3 id="weapon-beast-cutter" className="text-2xl mb-6 font-bold text-gray-800 flex items-center gap-2">
                     野兽切割刀 (Beast Cutter)
                   </h3>
                   ...
                   <div className="bg-white/60 rounded-lg p-3 overflow-x-auto mb-6 border border-gray-200">
                     <table className="w-full text-sm text-center">
                       ...
                       <tbody>
                         <tr className="border-b border-gray-100"><td>0</td><td>92</td><td>D</td><td>E</td><td>-</td><td>E</td></tr>
                         <tr className="border-b border-gray-100"><td>1</td><td>101</td><td>D</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>2</td><td>110</td><td>D</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>3</td><td>119</td><td>D</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>4</td><td>128</td><td>D</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>5</td><td>137</td><td>D</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>6</td><td>146</td><td>D</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>7</td><td>155</td><td>C</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>8</td><td>164</td><td>C</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>9</td><td>173</td><td>C</td><td>E</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>10</td><td>184</td><td>C</td><td>D</td><td>-</td><td>D</td></tr>
                       </tbody>
                     </table>
                   </div>
                   ...
                   <div className="grid md:grid-cols-2 gap-6 mb-6">
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       ...
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>11 - 25</td><td>3.21</td><td>45</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>1.56</td><td>39</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.33</td><td>16</td></tr>
                         </tbody>
                       </table>
                     </div>
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       ...
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>9 - 25</td><td>1.71</td><td>24</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>0.76</td><td>19</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.18</td><td>9</td></tr>
                         </tbody>
                       </table>
                     </div>
                 ...
                 {/* 送葬之刃 */}
                 <div className="pt-8 border-t border-gray-200">
                   <h3 id="weapon-burial-blade" className="text-2xl mb-6 font-bold text-gray-800 flex items-center gap-2">
                     送葬之刃 (Burial Blade)
                   </h3>
                   ...
                   <div className="bg-white/60 rounded-lg p-3 overflow-x-auto mb-6 border border-gray-200">
                     <table className="w-full text-sm text-center">
                       ...
                       <tbody>
                         <tr className="border-b border-gray-100"><td>0</td><td>80</td><td>30</td><td>E</td><td>C</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>1</td><td>88</td><td>33</td><td>E</td><td>C</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>2</td><td>96</td><td>36</td><td>E</td><td>C</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>3</td><td>104</td><td>39</td><td>E</td><td>C</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>4</td><td>112</td><td>42</td><td>E</td><td>C</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>5</td><td>120</td><td>45</td><td>E</td><td>B</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>6</td><td>128</td><td>48</td><td>E</td><td>B</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>7</td><td>136</td><td>51</td><td>E</td><td>B</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>8</td><td>144</td><td>54</td><td>E</td><td>B</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>9</td><td>152</td><td>57</td><td>E</td><td>B</td><td>-</td><td>B</td></tr>
                         <tr className="border-b border-gray-100"><td>10</td><td>160</td><td>60</td><td>D</td><td>B</td><td>-</td><td>B</td></tr>
                       </tbody>
                     </table>
                   </div>
                   ...
                   <div className="grid md:grid-cols-3 gap-6 mb-6">
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       ...
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>11 - 25</td><td>1.53</td><td>23</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>0.68</td><td>17</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.14</td><td>7</td></tr>
                         </tbody>
                       </table>
                     </div>
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       ...
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>13 - 25</td><td>3.69</td><td>48</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>1.68</td><td>42</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.37</td><td>18</td></tr>
                         </tbody>
                       </table>
                     </div>
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       <h4 className="font-bold text-gray-800 mb-2 text-center text-sm">平均物理攻击力提升 (奥术)</h4>
                       <table className="w-full text-xs text-center">
                         <thead>
                           <tr className="border-b border-gray-200 bg-gray-50">
                             <th className="py-1 px-2">范围</th>
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>8 - 25</td><td>1.11</td><td>20</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>0.60</td><td>15</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.12</td><td>6</td></tr>
                         </tbody>
                       </table>
                     </div>
                   </div>
                 ...
                 {/* 慈悲之刃 */}
                 <div className="pt-8 border-t border-gray-200">
                   <h3 id="weapon-blade-of-mercy" className="text-2xl mb-6 font-bold text-gray-800 flex items-center gap-2">
                     慈悲之刃 (Blade of Mercy)
                   </h3>
                   ...
                   <div className="bg-white/60 rounded-lg p-3 overflow-x-auto mb-6 border border-gray-200">
                     <table className="w-full text-sm text-center">
                       ...
                       <tbody>
                         <tr className="border-b border-gray-100"><td>0</td><td>60</td><td>30</td><td>-</td><td>C</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>1</td><td>66</td><td>33</td><td>-</td><td>B</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>2</td><td>72</td><td>36</td><td>-</td><td>B</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>3</td><td>78</td><td>39</td><td>-</td><td>B</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>4</td><td>84</td><td>42</td><td>-</td><td>B</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>5</td><td>90</td><td>45</td><td>-</td><td>A</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>6</td><td>96</td><td>48</td><td>-</td><td>A</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>7</td><td>102</td><td>51</td><td>-</td><td>A</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>8</td><td>108</td><td>54</td><td>-</td><td>A</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>9</td><td>114</td><td>57</td><td>-</td><td>A</td><td>-</td><td>B</td></tr>
                         <tr className="border-b border-gray-100"><td>10</td><td>120</td><td>60</td><td>-</td><td>S</td><td>-</td><td>B</td></tr>
                       </tbody>
                     </table>
                   </div>
                   ...
                   <div className="grid md:grid-cols-2 gap-6 mb-6">
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       ...
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>12 - 25</td><td>4.00</td><td>56</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>1.84</td><td>46</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.41</td><td>20</td></tr>
                         </tbody>
                       </table>
                     </div>
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       ...
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>8 - 25</td><td>1.00</td><td>18</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>0.60</td><td>15</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.12</td><td>6</td></tr>
                         </tbody>
                       </table>
                 ...
                 {/* 步枪矛 */}
                 <div className="pt-8 border-t border-gray-200">
                   <h3 id="weapon-rifle-spear" className="text-2xl mb-6 font-bold text-gray-800 flex items-center gap-2">
                     步枪矛 (Rifle Spear)
                   </h3>
                   ...
                   <div className="bg-gray-50 p-3 rounded-lg border border-gray-200 mb-6 flex gap-6 text-sm">
                     <div><strong className="text-red-600">力量:</strong> 10</div>
                     <div><strong className="text-blue-600">技巧:</strong> 11</div>
                     <div><strong className="text-red-900">血质:</strong> 9</div>
                     <div><strong className="text-purple-600">奥术:</strong> -</div>
                   </div>
                   ...
                   <div className="bg-white/60 rounded-lg p-3 overflow-x-auto mb-6 border border-gray-200">
                     <table className="w-full text-sm text-center">
                       ...
                       <tbody>
                         <tr className="border-b border-gray-100"><td>0</td><td>85</td><td>85</td><td>E</td><td>D</td><td>D</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>1</td><td>93</td><td>93</td><td>E</td><td>D</td><td>D</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>2</td><td>101</td><td>101</td><td>E</td><td>D</td><td>D</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>3</td><td>109</td><td>109</td><td>E</td><td>C</td><td>D</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>4</td><td>117</td><td>117</td><td>E</td><td>C</td><td>D</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>5</td><td>125</td><td>125</td><td>E</td><td>C</td><td>D</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>6</td><td>133</td><td>133</td><td>E</td><td>C</td><td>D</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>7</td><td>141</td><td>141</td><td>E</td><td>C</td><td>C</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>8</td><td>149</td><td>149</td><td>E</td><td>B</td><td>C</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>9</td><td>157</td><td>157</td><td>E</td><td>B</td><td>C</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>10</td><td>170</td><td>170</td><td>D</td><td>B</td><td>B</td><td>C</td></tr>
                       </tbody>
                     </table>
                   </div>
                   ...
                   <div className="grid md:grid-cols-3 gap-6 mb-6">
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       ...
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>11 - 25</td><td>1.53</td><td>23</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>0.68</td><td>17</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.16</td><td>8</td></tr>
                         </tbody>
                       </table>
                     </div>
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       ...
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>12 - 25</td><td>3.57</td><td>50</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>1.64</td><td>41</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.37</td><td>18</td></tr>
                         </tbody>
                       </table>
                     </div>
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       ...
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>10 - 25</td><td>3.19</td><td>51</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>1.52</td><td>38</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.35</td><td>17</td></tr>
                         </tbody>
                       </table>
                     </div>
                   </div>
                 ...
                 {/* 打桩机 */}
                 <div className="pt-8 border-t border-gray-200">
                   <h3 id="weapon-stake-driver" className="text-2xl mb-6 font-bold text-gray-800 flex items-center gap-2">
                     打桩机 (Stake Driver)
                   </h3>
                   ...
                   <div className="bg-white/60 rounded-lg p-3 overflow-x-auto mb-6 border border-gray-200">
                     <table className="w-full text-sm text-center">
                       ...
                       <tbody>
                         ...
                         <tr className="border-b border-gray-100"><td>3</td><td>109</td><td>D</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>4</td><td>117</td><td>D</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>5</td><td>125</td><td>D</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>6</td><td>133</td><td>D</td><td>D</td><td>-</td><td>D</td></tr>
                         <tr className="border-b border-gray-100"><td>7</td><td>141</td><td>D</td><td>D</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>8</td><td>149</td><td>C</td><td>D</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>9</td><td>157</td><td>C</td><td>D</td><td>-</td><td>C</td></tr>
                         <tr className="border-b border-gray-100"><td>10</td><td>170</td><td>C</td><td>C</td><td>-</td><td>C</td></tr>
                       </tbody>
                     </table>
                   </div>
                   ...
                   <div className="grid md:grid-cols-2 gap-6 mb-6">
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       ...
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>19 - 25</td><td>3.14</td><td>22</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>1.40</td><td>35</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.33</td><td>16</td></tr>
                         </tbody>
                       </table>
                     </div>
                     <div className="bg-white/60 rounded-lg p-3 border border-gray-200">
                       ...
                       <table className="w-full text-xs text-center">
                         ...
                         <tbody>
                           <tr className="border-b border-gray-100"><td>10 - 25</td><td>2.69</td><td>43</td></tr>
                           <tr className="border-b border-gray-100"><td>26 - 50</td><td>1.32</td><td>33</td></tr>
                           <tr className="border-b border-gray-100"><td>51 - 99</td><td>0.29</td><td>14</td></tr>
                         </tbody>
                       </table>
                     </div>
                   </div>
          ...
          <aside className="w-[280px] hidden xl:block flex-shrink-0">
            <div className="sticky top-[100px] bg-white rounded-lg p-6 shadow-sspai border border-gray-100 max-h-[calc(100vh-120px)] overflow-y-auto custom-scrollbar">
              <h3 className="font-bold text-lg mb-4 text-gray-900 flex items-center gap-2 border-b border-gray-100 pb-3">
                      ...
                      <a
                        ...
                        className={`flex-1 text-[14px] py-2 px-3 rounded-md transition-colors truncate
                          ${activeSection === item.id 
                            ? 'text-sspai-red font-bold bg-red-50' 
